...
.. "examples_regression/1-quickstart/plot_heteroscedastic_1d_data.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_regression_1-quickstart_plot_heteroscedastic_1d_data.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_1-quickstart_plot_heteroscedastic_1d_data.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 18-219



.. image-sg:: /examples_regression/1-quickstart/images/sphx_glr_plot_heteroscedastic_1d_data_001.png
   :alt: cv_plus, jackknife, jackknife_plus, jackknife_minmax, jackknife_plus_ab, conformalized_quantile_regression
   :srcset: /examples_regression/1-quickstart/images/sphx_glr_plot_heteroscedastic_1d_data_001.png
...
.. _sphx_glr_download_examples_regression_1-quickstart_plot_heteroscedastic_1d_data.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_heteroscedastic_1d_data.ipynb <plot_heteroscedastic_1d_data.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_heteroscedastic_1d_data.py <plot_heteroscedastic_1d_data.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_heteroscedastic_1d_data.zip <plot_heteroscedastic_1d_data.zip>`

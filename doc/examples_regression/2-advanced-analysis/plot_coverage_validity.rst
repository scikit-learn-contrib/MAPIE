...
.. "examples_regression/2-advanced-analysis/plot_coverage_validity.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_regression_2-advanced-analysis_plot_coverage_validity.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot_coverage_validity.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 50-170
...
.. GENERATED FROM PYTHON SOURCE LINES 177-266
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_001.png
   :alt: $|D_{cal}| = $6 and $\delta = $0.8
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 280-341
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_002.png
   :alt: $|D_{cal}| = $6 and $\delta = $0.8
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_002.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 348-397
...
.. GENERATED FROM PYTHON SOURCE LINES 405-449
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_003.png
   :alt: $|D_{cal}| = $12 and $\delta = $0.8
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_003.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 461-555
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_004.png
   :alt: $\delta = $0.8
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_coverage_validity_004.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 37.419 seconds)


.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot_coverage_validity.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_coverage_validity.ipynb <plot_coverage_validity.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_coverage_validity.py <plot_coverage_validity.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_coverage_validity.zip <plot_coverage_validity.zip>`

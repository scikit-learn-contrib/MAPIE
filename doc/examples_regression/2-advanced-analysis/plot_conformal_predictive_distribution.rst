...
.. "examples_regression/2-advanced-analysis/plot_conformal_predictive_distribution.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_regression_2-advanced-analysis_plot_conformal_predictive_distribution.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot_conformal_predictive_distribution.py:
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_001.png
   :alt: plot conformal predictive distribution
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 96-126
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_002.png
   :alt: plot conformal predictive distribution
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_003.png
   :alt: plot conformal predictive distribution
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_conformal_predictive_distribution_003.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot_conformal_predictive_distribution.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_conformal_predictive_distribution.ipynb <plot_conformal_predictive_distribution.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_conformal_predictive_distribution.py <plot_conformal_predictive_distribution.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_conformal_predictive_distribution.zip <plot_conformal_predictive_distribution.zip>`

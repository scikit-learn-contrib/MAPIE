...
.. "examples_regression/2-advanced-analysis/plot_timeseries_enbpi.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_regression_2-advanced-analysis_plot_timeseries_enbpi.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot_timeseries_enbpi.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 32-234



.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_timeseries_enbpi_001.png
   :alt: EnbPI, without update Coverage:1.000  Width:0.712, EnbPI with update Coverage:1.000  Width:0.698
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_timeseries_enbpi_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    EnbPI, with no update, width optimization
    ...
    EnbPI without any update:1.000, 0.712
    Coverage / prediction interval width mean for TimeSeriesRegressor: 
    EnbPI with update:1.000, 0.698
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 32.728 seconds)


.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot_timeseries_enbpi.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_timeseries_enbpi.ipynb <plot_timeseries_enbpi.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_timeseries_enbpi.py <plot_timeseries_enbpi.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_timeseries_enbpi.zip <plot_timeseries_enbpi.zip>`

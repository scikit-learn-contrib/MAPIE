...
.. "examples_regression/2-advanced-analysis/plot_ResidualNormalisedScore_tutorial.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_regression_2-advanced-analysis_plot_ResidualNormalisedScore_tutorial.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot_ResidualNormalisedScore_tutorial.py:
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_ResidualNormalisedScore_tutorial_001.png
   :alt: Histogram of house prices
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_ResidualNormalisedScore_tutorial_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 104-304
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_ResidualNormalisedScore_tutorial_002.png
   :alt: Predicted values and intervals of level 0.9, Default - coverage=90% - max violation=69%, Base model prefit - coverage=87% - max violation=64%, Base and residual model prefit - coverage=89% - max violation=78%, Wrapped residual model - coverage=88% - max violation=43%
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_ResidualNormalisedScore_tutorial_002.png
   :class: sphx-glr-single-img
...
.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot_ResidualNormalisedScore_tutorial.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_ResidualNormalisedScore_tutorial.py <plot_ResidualNormalisedScore_tutorial.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_ResidualNormalisedScore_tutorial.ipynb <plot_ResidualNormalisedScore_tutorial.ipynb>`

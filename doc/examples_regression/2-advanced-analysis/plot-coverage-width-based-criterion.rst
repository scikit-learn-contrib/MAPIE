...
.. "examples_regression/2-advanced-analysis/plot-coverage-width-based-criterion.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_regression_2-advanced-analysis_plot-coverage-width-based-criterion.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot-coverage-width-based-criterion.py:
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot-coverage-width-based-criterion_001.png
   :alt: plot coverage width based criterion
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot-coverage-width-based-criterion_001.png
...
.. GENERATED FROM PYTHON SOURCE LINES 121-184
...
.. GENERATED FROM PYTHON SOURCE LINES 188-242
...
.. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot-coverage-width-based-criterion_002.png
   :alt: jackknife_plus, jackknife_minmax, cv_plus, cv_minmax, jackknife_plus_ab, conformalized_quantile_regression
   :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot-coverage-width-based-criterion_002.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 247-275
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
                                       ...
                                       Coverage  Width average  Coverage Width-based Criterion
    cv                                     0.95           6.85                            0.59
    cv_plus                                0.95           6.85                            0.59
    cv_minmax                              0.96           7.11                            0.58
    jackknife                              0.95           6.84                            0.59
    jackknife_plus                         0.95           6.84                            0.59
    jackknife_minmax                       0.96           7.02                            0.58
    jackknife_plus_ab                      0.95           6.61                            0.61
    jackknife_minmax_ab                    0.96           6.96                            0.58
    conformalized_quantile_regression      0.98           6.46                            0.61
...
.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot-coverage-width-based-criterion.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot-coverage-width-based-criterion.py <plot-coverage-width-based-criterion.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot-coverage-width-based-criterion.ipynb <plot-coverage-width-based-criterion.ipynb>`

...
.. "examples_regression/3-scientific-articles/plot_kim2020_simulations.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_regression_3-scientific-articles_plot_kim2020_simulations.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_3-scientific-articles_plot_kim2020_simulations.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 33-509
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_001.png
         :alt:   Agg. function = mean Model = Ridge2  Data=BLOG, J+, J+aB
         :srcset: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_002.png
         :alt:   Agg. function = mean Model = Ridge2  Data=BLOG, Fixed B, Random B
         :srcset: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_003.png
         :alt:   Agg. function = mean Model = Ridge2  Data=BLOG, J+, J+aB
         :srcset: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_004.png
         :alt:   Agg. function = mean Model = Ridge2  Data=BLOG, Fixed B, Random B
         :srcset: /examples_regression/3-scientific-articles/images/sphx_glr_plot_kim2020_simulations_004.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 41.650 seconds)


.. _sphx_glr_download_examples_regression_3-scientific-articles_plot_kim2020_simulations.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_kim2020_simulations.ipynb <plot_kim2020_simulations.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_kim2020_simulations.py <plot_kim2020_simulations.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_kim2020_simulations.zip <plot_kim2020_simulations.zip>`

...
.. "examples_regression/2-advanced-analysis/plot_both_uncertainties.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_regression_2-advanced-analysis_plot_both_uncertainties.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_regression_2-advanced-analysis_plot_both_uncertainties.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 13-211
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_both_uncertainties_001.png
         :alt: jackknife_plus, cv_plus, jackknife_plus_ab, conformalized_quantile_regression
         :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_both_uncertainties_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_both_uncertainties_002.png
         :alt: plot both uncertainties
         :srcset: /examples_regression/2-advanced-analysis/images/sphx_glr_plot_both_uncertainties_002.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_examples_regression_2-advanced-analysis_plot_both_uncertainties.py:

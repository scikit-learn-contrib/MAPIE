...
.. "examples_classification/2-advanced-analysis/plot_crossconformal.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_classification_2-advanced-analysis_plot_crossconformal.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_classification_2-advanced-analysis_plot_crossconformal.py:
...
.. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_001.png
   :alt: plot crossconformal
   :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_001.png
...
.. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_002.png
   :alt: Distribution of scores on each conformity fold for the lac conformity score, split=0 quantile=0.685, split=1 quantile=0.557, split=2 quantile=0.544, split=3 quantile=0.630, split=4 quantile=0.606
   :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_003.png
         :alt: Number of labels in prediction sets for the lac conformity score, coverage = 0.916, coverage = 0.882, coverage = 0.878, coverage = 0.903, coverage = 0.897
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_004.png
         :alt: Number of labels in prediction sets for the aps conformity score, coverage = 0.982, coverage = 0.980, coverage = 0.972, coverage = 0.975, coverage = 0.975
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_004.png
         :class: sphx-glr-multi-img
...
.. GENERATED FROM PYTHON SOURCE LINES 224-278
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_005.png
         :alt: Effective coverage and prediction set size for the lac conformity score
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_005.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_006.png
         :alt: Effective coverage and prediction set size for the aps conformity score
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_006.png
         :class: sphx-glr-multi-img
...
.. GENERATED FROM PYTHON SOURCE LINES 310-378
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_007.png
         :alt: Effective coverage and prediction set size for the lac conformity score
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_007.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_008.png
         :alt: Effective coverage and prediction set size for the aps conformity score
         :srcset: /examples_classification/2-advanced-analysis/images/sphx_glr_plot_crossconformal_008.png
         :class: sphx-glr-multi-img
...
.. GENERATED FROM PYTHON SOURCE LINES 423-439
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    lac   0.00764     0.00764  0.014893
    aps  0.008273    0.006304  0.017948
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  38.168 seconds)


.. _sphx_glr_download_examples_classification_2-advanced-analysis_plot_crossconformal.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_crossconformal.py <plot_crossconformal.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_crossconformal.ipynb <plot_crossconformal.ipynb>`

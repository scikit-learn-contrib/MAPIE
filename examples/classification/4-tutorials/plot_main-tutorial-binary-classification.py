...
estimated by :class:`~mapie.classification.MapieClassifier` with the "label"
...
mapie_clf = MapieClassifier(
    estimator=calib, method='label', cv='prefit', random_state=42
)
...
#   base estimator.
#
# - ``y_ps_mapie``: the prediction sets estimated by MAPIE using the "label"
#   method.
#
...
plot_scores(alpha, conformity_scores, quantiles, 'label', axs)
plt.show()
...
print(
    f"Accuracy of the model with 'label' method: "
...
plot_coverages_widths(alpha_, coverage, mean_width, 'label')
